  ...
  return (
    <>
      {/* <div classNameName="flex flex-col justify-center items-center">
        <img src="public/404.gif" alt="404" classNameName="w-96 h-96" />
        <h1 classNameName="text-3xl font-pacifico">Whooops!</h1>
        <p>Sorry, the page you are looking for doesn&apos;t exist</p>
      </div> */}
      <div>
        <div className="flex flex-col justify-center items-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080"  className="md:h-96 sm:w-full">
            <title>404</title>
          ...
          <div className="flex flex-col justify-center items-center mx-2 self-center gap-2">
            <h1 className="text-3xl font-semibold text-logo font-pacifico">
              Whooops!
            </h1>
            <p className="text-2xl text-center font-pacifico text-logo opacity-70">
